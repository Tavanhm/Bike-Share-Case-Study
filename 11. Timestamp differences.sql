...
As subscriptions move through the payment statuses, they are logged in the paymentstatuslog table using the statusid to show what status they moved up to. They can go back and forth and move through status multiple times.
